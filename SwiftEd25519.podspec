...
Pod::Spec.new do |s|
  s.name             = 'SwiftEd25519'
  s.version          = '0.1.0'
  s.summary          = 'A short description of SwiftEd25519.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/work_cocody@hotmail.com/SwiftEd25519'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'work_cocody@hotmail.com' => 'qiuhongyang@askcoin.org' }
  s.source           = { :git => 'https://github.com/work_cocody@hotmail.com/SwiftEd25519.git', :tag => s.version.to_s }
